                ...
                <form id="section-form">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="AEMT" id="skill-aemt">
                                <label class="form-check-label" for="skill-aemt">AEMT</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="Intermediate" id="skill-intermediate">
                                <label class="form-check-label" for="skill-intermediate">Intermediate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="Paramedic" id="skill-paramedic">
                                <label class="form-check-label" for="skill-paramedic">Paramedic</label>
                            </div>
                        </div>
                    </div>
