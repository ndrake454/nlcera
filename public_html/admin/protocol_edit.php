...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_action'])) {
    ...
    $contact_base = (isset($_POST['contact_base']) && $_POST['contact_base'] == 1) ? 1 : 0;
                            ...
                            <div class="card-body p-2">
                                <div class="mb-3">
                                    <select class="form-select form-select-sm" id="component-type-filter">
                                        ...
                                        <option value="join">Join Sections</option>
                                ...
                                <div id="component-library" class="component-list">
                                    ...
                                    <!-- Green Down Arrow Component -->
                                    <div class="component-item" data-type="green_arrow">
                                        <div class="d-flex align-items-center">
                                            <i class="ti ti-arrow-down-circle me-2" style="color: #28a745;"></i>
                                            <div>
                                                <strong>Green Down Arrow</strong>
                                                <div class="small text-muted">Positive directional indicator</div>
                                            </div>
                                        </div>
                                    </div>

                                    <!-- Join Component -->
                                    <div class="component-item" data-type="join">
                                        <div class="d-flex align-items-center">
                                            <i class="ti ti-arrows-join me-2" style="color: #6c757d;"></i>
                                            <div>
                                                <strong>Join Sections</strong>
                                                <div class="small text-muted">Removes space between sections</div>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <!-- Diagram/Flowchart Component -->
                                    <div class="component-item" data-type="diagram">
                                        <div class="d-flex align-items-center">
                                            <i class="ti ti-chart-arrows me-2" style="color: #3572b0;"></i>
                                            <div>
                                                <strong>Flowchart</strong>
                                                <div class="small text-muted">Interactive diagram</div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($sections as $section): ?>
                                    ...
                                    <div class="protocol-section" data-section-id="<?= $section['id'] ?>" data-section-type="<?= $section['section_type'] ?>">
                                        <?php if ($section['section_type'] === 'red_arrow' || $section['section_type'] === 'green_arrow' || $section['section_type'] === 'join'): ?>
                                            <!-- Simple components don't need a header, just the content -->
                                            <?php if ($section['section_type'] === 'red_arrow'): ?>
                                                <div class="red-arrow">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle-fill" viewBox="0 0 16 16">
                                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/>
                                                    </svg>
                                            <?php elseif ($section['section_type'] === 'green_arrow'): ?>
                                                <div class="green-arrow">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle-fill" viewBox="0 0 16 16">
                                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/>
                                                    </svg>
                                            <?php elseif ($section['section_type'] === 'join'): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="protocol-section-header">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <?php elseif ($section['section_type'] === 'diagram'): ?>
                                                        <i class="ti ti-chart-arrows me-2"></i>
                                                        <span>Flowchart: <?= $section['title'] ?></span>
...
<div class="modal fade" id="diagram-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="diagram-modal-title">Flowchart Editor</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-0">
                <input type="hidden" id="diagram-section-id" value="0">
                <input type="hidden" id="diagram-data" value="">
                <div id="diagram-editor" style="width: 100%; height: calc(100vh - 120px); border: none;"></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" id="save-diagram-btn">Save Diagram</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#protocol-editor-area').droppable({
        ...
        drop: function(event, ui) {
            ...
            // Special handling for diagram component
            if (sectionType === 'diagram') {
                openDiagramEditor(0, 'diagram');
            } else {
                // Open the regular section modal for other component types
    ...
    $(document).on('click', '.edit-section-btn', function() {
        ...
        if (sectionType === 'diagram') {
            // Use specialized diagram editor
            openDiagramEditor(sectionId, sectionType);
        } else {
            // Use regular section editor
    ...
    $('#save-section-btn').click(function() {
        ...
        // MODIFY THIS LINE - Add a console.log to verify the value
        const contactBase = $('#contact-base').is(':checked') ? 1 : 0;
        console.log('Contact Base Value when saving:', contactBase, $('#contact-base').is(':checked'));
    ...
    function openSectionModal(sectionId, sectionType, templateId = 0) {
        ...
        if (sectionType === 'diagram') {
            // Use the specialized diagram editor instead
            openDiagramEditor(sectionId, sectionType);
            return; // Skip the regular modal
        }
        ...
        // Explicitly ensure the checkbox is unchecked
        $('#contact-base').prop('checked', false);
        console.log("Checkbox initial state:", $('#contact-base').is(':checked'));
        ...
        // Set default values for each special section type
        if (sectionType === 'red_arrow') {
            defaultTitle = 'Direction Indicator';
            defaultContent = '<div class="red-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/></svg></div>';
        } else if (sectionType === 'green_arrow') {
            defaultTitle = 'Green Direction Indicator';
            defaultContent = '<div class="green-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle-fill" viewBox="0 0 16 16"><path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/></svg></div>';
        } else if (sectionType === 'join') {
            defaultTitle = 'Join Sections';
            defaultContent = '<div class="join-marker"></div>';
        } else if (sectionType === 'indications') {
            defaultTitle = 'Indications';
            defaultContent = '<ul><li>Add indications here</li></ul>';
        } else if (sectionType === 'contraindications') {
            defaultTitle = 'Contraindications';
            defaultContent = '<ul><li>Add contraindications here</li></ul>';
        } else if (sectionType === 'side_effects') {
            defaultTitle = 'Side Effects';
            defaultContent = '<ul><li>Add side effects here</li></ul>';
        } else if (sectionType === 'precautions') {
            defaultTitle = 'Precautions';
            defaultContent = '<ul><li>Add precautions here</li></ul>';
        } else if (sectionType === 'technique') {
            defaultTitle = 'Technique';
            defaultContent = '<ol><li>Step 1</li><li>Step 2</li></ol>';
        }
        
        // Set default title if available
        if (defaultTitle) {
            $('#section-title').val(defaultTitle);
        }
        ...
        setTimeout(() => {
            ...
            if (sectionId === 0) {
                // Initialize Quill with default content for new section
                sectionQuill = initQuill(editorElement, 'Enter content here...', defaultContent);
                ...
                $.getJSON(`../api/get_section.php?id=${sectionId}`, function(data) {
                    if (data.success) {
                        ...
                        const contactBaseChecked = section.contact_base == 1;
                        $('#contact-base').prop('checked', contactBaseChecked);
                        console.log("Loading section data - contact_base value:", section.contact_base, "Setting checkbox to:", contactBaseChecked);
    ...
    // Function to open diagram editor
    function openDiagramEditor(sectionId, sectionType) {
        console.log("Opening diagram editor for section:", sectionId);
        
        // Reset diagram data
        $('#diagram-section-id').val(sectionId);
        $('#diagram-data').val('');
        
        // If this is an edit, load existing diagram data
        if (sectionId !== 0) {
            $.getJSON(`../api/get_section.php?id=${sectionId}`, function(data) {
                if (data.success) {
                    const section = data.section;
                    $('#diagram-data').val(section.content);
                    
                    // Initialize diagram editor with existing data
                    initDiagramEditor(section.content);
                } else {
                    alert('Failed to load diagram data: ' + data.message);
                    initDiagramEditor();
                }
            }).fail(function() {
                alert('Failed to load diagram data. Please try again.');
                initDiagramEditor();
            });
        } else {
            // Initialize empty diagram editor
            initDiagramEditor();
        }
        
        // Show the diagram modal
        const diagramModal = new bootstrap.Modal(document.getElementById('diagram-modal'));
        diagramModal.show();
    }
    
    // Function to initialize the Draw.io editor
    function initDiagramEditor(initialXml = null) {
        ...
        const options = {
            chrome: 0,
            libs: ['general', 'flowchart', 'healthcare', 'uml'],
            defaultLibraries: 'general;flowchart;healthcare',
            ui: 'dark', // or 'kennedy' for a lighter theme
            xml: initialXml || '<mxfile></mxfile>',
            border: 0,
            ready: function() {
                console.log('Draw.io editor loaded successfully');
            },
            error: function(err) {
                console.error('Error loading Draw.io editor:', err);
                alert('Error loading diagram editor. Please try again.');
            }
        };
        
        // Initialize Draw.io editor
        try {
            const drawioFrame = document.createElement('iframe');
            drawioFrame.style.width = '100%';
            drawioFrame.style.height = '100%';
            drawioFrame.style.border = 'none';
            editor.appendChild(drawioFrame);
            
            // Use Draw.io edit mode
            const url = 'https://embed.diagrams.net/?embed=1&proto=json';
            drawioFrame.setAttribute('src', url);
            
            // Handle messages from the iframe
            window.addEventListener('message', function(evt) {
                if (evt.data.length > 0 && evt.source === drawioFrame.contentWindow) {
                    try {
                        const msg = JSON.parse(evt.data);
                        
                        if (msg.event === 'init') {
                            // Send initial content to the editor
                            ...
                            // Store diagram XML when saved
                            $('#diagram-data').val(msg.xml);
                        }
                        else if (msg.event === 'exit') {
                            // Close modal when exit is pressed
            ...
            editor.innerHTML = '<div class="alert alert-danger">Failed to load diagram editor</div>';
        }
    }
    
    // Save Diagram Button Click
    $('#save-diagram-btn').click(function() {
        const sectionId = $('#diagram-section-id').val();
        const diagramXml = $('#diagram-data').val();
        
        // Request the diagram content from the editor
        const drawioFrame = document.querySelector('#diagram-editor iframe');
        if (drawioFrame) {
            drawioFrame.contentWindow.postMessage(JSON.stringify({action: 'export', format: 'xml'}), '*');
            
            // Wait a moment for the response before submitting
            setTimeout(function() {
                saveDiagramSection(sectionId, diagramXml);
            }, 500);
        } else {
            alert('Diagram editor not initialized properly');
        }
    });
    
    // Function to save diagram section
    function saveDiagramSection(sectionId, diagramXml) {
        const title = 'Flowchart';
        ...
        if (sectionId === '0') {
            ...
            $.post('protocol_edit.php?id=<?= $protocol_id ?>', {
                ...
                if (response.success) {
                    ...
                    alert('Failed to add diagram: ' + response.message);
                }
            }, 'json');
        } else {
            // Update existing section
            $.post('protocol_edit.php?id=<?= $protocol_id ?>', {
                ...
                if (response.success) {
                    ...
                    alert('Failed to update diagram: ' + response.message);
                }
            }, 'json');
        }
    }
    
    // Add a special handler for diagram components
    $(document).on('click', '.view-diagram-btn', function(e) {
        e.preventDefault();
        ...
        openDiagramEditor(sectionId, 'diagram');
    });
    ...
    function loadProtocolPreview() {
        ...
        $('#protocol-preview-content').load('../protocol.php?id=<?= $protocol_id ?>&preview=1', function() {
            // Initialize diagrams after loading preview
            initializeDiagrams();
        });
    }
    
    // Function to initialize diagrams in the preview
        ...
        document.querySelectorAll('.diagram-container').forEach(function(container) {
            ...
            if (xmlElement) {
                ...
                try {
                    ...
                    container.innerHTML += '<div class="alert alert-danger">Failed to load diagram</div>';
                }
            }
        });
    }
