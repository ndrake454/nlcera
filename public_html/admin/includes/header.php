...
<head>
    ...
    <!-- Draw.io Integration -->
<script src="https://app.diagrams.net/js/viewer.min.js" defer></script>
<script src="https://app.diagrams.net/js/embed.min.js" defer></script>
    ...
    <style>
        ...
        /* Hide placeholder when viewer is loaded */
        .diagram-container.geDiagramContainer .diagram-placeholder {
            display: none;
        }
        
        /* Fullscreen modal for diagram editor */
        .modal-fullscreen {
            width: 100vw;
            max-width: none;
            height: 100%;
