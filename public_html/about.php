                        ...
                        <div class="row align-items-center">
                            <div class="col-md-4 text-center mb-4 mb-md-0">
                                <div class="developer-profile">
                                    ...
                                    <h3 class="mt-3">Nathan Drake</h3>
                                    <p class="text-muted">Developer</p>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <p>Hello. My name is Nathan Drake, the developer behind this site.</p>
                                ...
                                <div class="contact-info mt-4">
                                    <div class="contact-item">
                                        ...
                                        <span>admin@firelight.academy</span>
                                    </div>
                                    <div class="contact-item">
                            ...
                            <div class="col-md-6">
                                <div class="tech-category">
                                    ...
                                    <ul class="tech-list">
                                        ...
                                        <li><span class="tech-badge">Quill.js</span> Rich text editing</li>
