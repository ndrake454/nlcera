...
<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
    ...
    <!-- Drug Calc -->
    <div class="col">
        <a href="<?= $base_url ?>/tools/dose.php" class="category-card-link">
            <div class="card-body">
                <div class="category-icon">
                    <i class="ti"></i>
                </div>
                <h4>Dosing Calculator</h4>
                <p>Concentration, drip rate, etc.</p>
            </div>
        </a>
    </div>
    ...
    <!-- Winters formula -->
    <div class="col">
        <a href="<?= $base_url ?>/tools/winters.php" class="category-card-link">
            <div class="card-body">
                <div class="category-icon">
                    <i class="ti"></i>
                </div>
                <h4>Winters Formula</h4>
                <p>For patient's with a suspected purely metabolic acidosis.</p>
            </div>
        </a>
    </div>
    ...
    <!-- Altitude FiO2 -->
    <div class="col">
        <a href="<?= $base_url ?>/tools/altitudefio2.php" class="category-card-link">
            <div class="card-body">
                <div class="category-icon">
                    <i class="ti"></i>
                </div>
                <h4>Altitude FiO2 Formula</h4>
                <p>For adjusting patient's expected FiO2 upon arrival at destination with different altitude.</p>
            </div>
        </a>
    </div>
</div>
