 ...
 * 
 * Place this file in: /tool_ibw.php
 */
                    ...
                    <form id="ibwForm">
                        ...
                        <div class="mb-4">
                            <div class="btn-group units-toggle w-100">
                                <input type="radio" class="btn-check" name="units" id="imperialUnits" value="imperial" checked>
                                <label class="btn btn-outline-primary" for="imperialUnits">Imperial (ft/in, lbs)</label>
                                
                                <input type="radio" class="btn-check" name="units" id="metricUnits" value="metric">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="btn-group gender-toggle w-100" role="group">
                                <input type="radio" class="btn-check" name="gender" id="maleGender" value="male" checked>
                                <label class="btn btn-outline-primary" for="maleGender">Male</label>
                                
                                <input type="radio" class="btn-check" name="gender" id="femaleGender" value="female">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="btn-group age-toggle w-100" role="group">
                                <input type="radio" class="btn-check" name="ageGroup" id="adultAge" value="adult" checked>
                                <label class="btn btn-outline-primary" for="adultAge">Adult</label>
                                
                                <input type="radio" class="btn-check" name="ageGroup" id="pediatricAge" value="pediatric">
                        ...
                        <div id="imperialHeightGroup" class="mb-4">
                            <label class="form-label d-flex align-items-center">
                                Height
                                <button type="button" class="info-btn ms-2" data-info="Enter the patient's height. For most accurate results, measure height rather than using stated height.">
                                    <i class="ti ti-info-circle"></i>
                                </button>
                            </label>
                            <div class="row g-2">
                                <div class="col-6">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-lg" id="heightFeet" min="1" max="9" value="5">
                                        <span class="input-group-text">ft</span>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-lg" id="heightInches" min="0" max="11" value="10">
                        ...
                        <div id="metricHeightGroup" class="mb-4" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control form-control-lg" id="heightCm" min="30" max="300" value="178">
                        ...
                        <div id="imperialWeightGroup" class="mb-4">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control form-control-lg" id="weightLbs" min="1" max="1000">
                        ...
                        <div id="metricWeightGroup" class="mb-4" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control form-control-lg" id="weightKg" min="1" max="500">
                        ...
                        <div id="pediatricAgeGroup" class="mb-4" style="display: none;">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control form-control-lg" id="ageYears" min="0" max="17" step="0.1" value="10">
                        ...
                        <div class="text-center mt-4">
                            <button type="button" id="calculateBtn" class="btn btn-primary btn-lg px-5">
                                <i class="ti ti-calculator me-2"></i>Calculate
                            </button>
                            <button type="button" id="resetBtn" class="btn btn-outline-secondary btn-lg ms-2">
            ...
            <div class="card mb-4" id="resultCard" style="display: none;">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="result-box" id="abwSection" style="display: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="result-box" id="bmiSection" style="display: none;">
        ...
        <div class="col-md-10">
            <div class="card mb-4">
                <div class="card-header section-header-reference">
                    <h2 class="h5 mb-0"><i class="ti ti-book me-2"></i>Clinical Applications</h2>
                </div>
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <p class="mb-0">Use IBW for calculating initial tidal volume (6-8 mL/kg).</p>
                                </div>
                                <button type="button" class="info-btn ms-3 flex-shrink-0" data-info="Tidal volume should be calculated at 6-8 mL/kg of Ideal Body Weight (not actual weight) to prevent barotrauma, especially in obese patients. For example, a patient with IBW of 70 kg should receive a tidal volume of 420-560 mL.">
                                    <i class="ti ti-info-circle"></i>
                                </button>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="d-flex align-items-start">
                                <div>
                                    ...
                                    <p class="mb-0">Different medications require different weight calculations for proper dosing.</p>
                                </div>
                                <button type="button" class="info-btn ms-3 flex-shrink-0" data-info="Hydrophilic medications (e.g., aminoglycosides, vancomycin) often use adjusted body weight for obese patients. Lipophilic medications (e.g., benzodiazepines, propofol) often use actual body weight for dosing, as they distribute into adipose tissue.">
                                    <i class="ti ti-info-circle"></i>
                                </button>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="d-flex align-items-start">
                                <div>
                                    <strong>Pediatric Patients</strong>
                                    <p class="mb-0">For pediatric patients, various methods exist for weight estimation.</p>
                                </div>
                                <button type="button" class="info-btn ms-3 flex-shrink-0" data-info="For children, we use age-based formulas like the following: <br>- Infants (< 12 months): Weight (kg) = (age in months + 9) / 2<br>- Children (1-10 years): Weight (kg) = (2 × age in years) + 8<br>- Broselow tape should be used when available for the most accurate estimates.">
                                    <i class="ti ti-info-circle"></i>
                                </button>
                            </div>
                        </li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize with a click on the calculate button if all required fields have values
    if (document.getElementById('heightFeet').value && document.getElementById('heightInches').value) {
        calculateBtn.click();
    }
});
</script>
