        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="section-form">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Provider Skill Levels (optional)</label>
                        <div class="d-flex flex-wrap gap-2">
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="EMR" data-fullname="Emergency Medical Responder" id="skill-emr">
                                <label class="form-check-label" for="skill-emr">EMR</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="EMT" data-fullname="Emergency Medical Technician" id="skill-emt">
                                <label class="form-check-label" for="skill-emt">EMT</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="EMT-A" data-fullname="Emergency Medical Technician - Advanced" id="skill-emta">
                                <label class="form-check-label" for="skill-emta">EMT-A</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="EMT-I" data-fullname="Emergency Medical Technician - Intermediate" id="skill-emti">
                                <label class="form-check-label" for="skill-emti">EMT-I</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="EMT-P" data-fullname="Emergency Medical Technician - Paramedic" id="skill-emtp">
                                <label class="form-check-label" for="skill-emtp">EMT-P</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="EMT-CC" data-fullname="Emergency Medical Technician - Critical Care" id="skill-emtcc">
                                <label class="form-check-label" for="skill-emtcc">EMT-CC</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input skill-level-checkbox" type="checkbox" value="RN" data-fullname="Registered Nurse" id="skill-rn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('.component-item').draggable({
        connectToSortable: '#protocol-editor-area',
        helper: 'clone',
        revert: 'invalid',
    ...
    // Also update the initModalEditor function with the same configuration:
function initModalEditor(content) {
    ...
    // Helper function to check if a value is empty (to fix JSON parse issues)
