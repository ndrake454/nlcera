...
<div class="row mb-4">
    ...
    <div class="col-md-3">
        <div class="card text-center h-100">
            <div class="card-body">
                <i class="ti ti-template text-warning" style="font-size: 3rem;"></i>
                <h2 class="mt-3"><?= $component_count ?></h2>
                <h5>Components</h5>
            </div>
            <div class="card-footer bg-light">
                <a href="components.php" class="btn btn-sm btn-warning">Manage Components</a>
            </div>
        </div>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <a href="category_add.php" class="btn btn-outline-success w-100 p-3">
                            <i class="ti ti-category-plus"></i><br>
                            Add New Category
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="component_add.php" class="btn btn-outline-warning w-100 p-3">
                            <i class="ti ti-template"></i><br>
                            Add New Component
                        </a>
                    </div>
                    <div class="col-6">
