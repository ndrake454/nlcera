...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateScore() {
        ...
        if (totalScore === 0) {
            ...
            interpretation = 'Patient has mild stroke symptoms. Generally favorable outcomes expected.';
        } else if (totalScore >= 5 && totalScore <= 15) {
            severity = 'Moderate Stroke';
            severityClass = 'severity-moderate';
            scoreCircleClass = 'score-moderate';
            interpretation = 'Patient has moderate stroke severity. May benefit from acute interventions.';
        } else if (totalScore >= 16 && totalScore <= 20) {
            severity = 'Moderate to Severe Stroke';
            severityClass = 'severity-moderate-severe';
            scoreCircleClass = 'score-high';
            interpretation = 'Patient has moderate to severe stroke. Immediate medical intervention required.';
        } else {
            severity = 'Severe Stroke';
            severityClass = 'severity-severe';
            scoreCircleClass = 'score-severe';
            interpretation = 'Patient has severe stroke with significant deficits. Urgent medical intervention required.';
        }
